...
## [0.7.2](https://github.com/rcelha/rio-rs/compare/rio-macros-v0.7.1...rio-macros-v0.7.2) - 2026-07-23

### Added

- Update license field on cargo.toml ([#54](https://github.com/rcelha/rio-rs/pull/54))

## [0.7.1](https://github.com/rcelha/rio-rs/compare/rio-macros-v0.7.0...rio-macros-v0.7.1) - 2026-07-23

### Other

- Configure release-plz ([#49](https://github.com/rcelha/rio-rs/pull/49))
